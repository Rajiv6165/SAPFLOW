...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_pipeline_runs_run_id"), "pipeline_runs", ["run_id"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_transport_records_transport_id"),
        "transport_records",
        ["transport_id"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_system_health_snapshots_recorded_at"),
        "system_health_snapshots",
        ["recorded_at"],
        unique=False,
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_transport_records_transport_id"), table_name="transport_records"
    )
