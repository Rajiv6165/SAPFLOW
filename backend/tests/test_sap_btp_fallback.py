...
def test_falls_back_to_mock_with_empty_credentials():
    async def run():
        settings = Settings(
            SAP_BTP_CLIENT_ID="",
            SAP_BTP_CLIENT_SECRET="",
            SAP_BTP_TOKEN_URL="",
            SAP_BTP_API_BASE_URL="",
        )
...
def test_falls_back_to_mock_with_placeholder_credentials():
    async def run():
        settings = Settings(
...
def test_falls_back_to_mock_with_invalid_real_looking_credentials():
