    ...
    async with AsyncSession(engine) as session:
        ...
        transports_data = [
            # LOGISTICS (3)
            {
                ...
                "description": "MM procurement config update",
                "source_system": "DEV",
                "target_system": "QA",
                "status": "success",
                "promoted_by": "rajiv.thakker",
                "hours_ago": 14,
                "landscape": "LOGISTICS",
            },
            {
                "transport_id": "DEVK900003",
                "description": "SD pricing procedure fix",
                "source_system": "DEV",
                "target_system": "QA",
                "status": "failed",
                "promoted_by": "rajiv.thakker",
            ...
            {
                "transport_id": "DEVK900010",
                "description": "MM routing config update",
                "source_system": "DEV",
                "target_system": "QA",
                "status": "in_progress",
                "promoted_by": "rajiv.thakker",
            ...
            # FINANCE (3)
            {
                ...
                "description": "FI document type change",
                "source_system": "DEV",
                "target_system": "QA",
                "status": "success",
                "promoted_by": "admin",
            ...
            {
                "transport_id": "DEVK900007",
                "description": "FI tax classification schema",
                "source_system": "DEV",
                "target_system": "QA",
                "status": "pending",
                "promoted_by": "admin",
            ...
            },  # Active 2
            {
                ...
                "description": "CO cost center hierarchy update",
                "source_system": "QA",
                "target_system": "PROD",
                "status": "success",
            ...
            # DEFAULT (4)
            {
                "transport_id": "DEVK900004",
                "description": "ABAP custom report Z_BASIS_CHECK",
                "source_system": "DEV",
                "target_system": "QA",
                "status": "success",
                "promoted_by": "ci-pipeline",
            ...
            {
                "transport_id": "DEVK900005",
                "description": "BASIS system parameter change",
                "source_system": "QA",
                "target_system": "PROD",
                "status": "success",
                "promoted_by": "admin",
            ...
            {
                "transport_id": "DEVK900006",
                "description": "PP routing configuration update",
                "source_system": "QA",
                "target_system": "PROD",
                "status": "in_progress",
                "promoted_by": "rajiv.thakker",
            ...
            {
                "transport_id": "DEVK900009",
                "description": "WM storage bin definition",
                "source_system": "QA",
                "target_system": "PROD",
                "status": "failed",
                "promoted_by": "rajiv.thakker",
        ...
        for t in transports_data:
            ...
            completed_at = (
                promoted_at + timedelta(seconds=random.randint(60, 300))
            ...
            record = TransportRecord(
                ...
                validation_report={
                    "validations_checked": 4,
                    "errors": 0 if t["status"] == "success" else 2,
                },
        ...
        for idx, r in enumerate(pipeline_runs_setup):
            ...
            completed_at = (
                triggered_at + timedelta(seconds=r["duration"])
                if r["duration"]
                else None
            )
